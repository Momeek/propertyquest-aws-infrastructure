...
export const getBusinessDocumentUrl = (file?: string) =>
  file
    ? `${process.env.NEXT_PUBLIC_API_HOST}/assets/businessFiles/${file}`
    : "";

export const getAffiliationDocumentUrl = (file?: string) =>
  file
    ? `${process.env.NEXT_PUBLIC_API_HOST}/assets/affiliationFiles/${file}`
    : "";
